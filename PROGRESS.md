# 进度
当前任务：T-024~T-030 完成（桌面顶栏导航 + 内容占满整行）。等用户复测：桌面弹窗顶部导航条、事项页卡片、侧边栏、手机端
上次检查点：T-026 完成（操作区固定轨道对齐 + 阶梯档位下调）
已完成：T-001~T-004、T-010~T-014、T-020、T-021、T-022、T-024、T-025、T-026、T-027、T-028、T-029、T-030
未提交变更：无
上次提交：feat(nav): desktop top navigation replaces the left rail
下一步：请用户用「集市 → 安装本地包」装 siyuan-checkin-v9.5.1-test.zip（或重启思源）后复测事项页与手机端；手工覆盖插件目录 + reloadUI 不会让前端换新（见记忆）
