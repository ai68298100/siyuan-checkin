...
## v18.4.0 已发布 / v18.5.0 候选待发（2026-09-25）
...
- [ ] **v18.5.0 发版（候选冻结，等用户指令）**：本地 11 提交——叶归 LifeLog 适配器全套（T-1457，e2e spec 已过）、外部协作完善（省电门+今日徽标）、认知觉醒五件套包（T-1456）、yeguif/docktomato e2e 修正。发版前动作：README「当前版本」声明同步（release-assets 守门会拦，v18.4.0 教训）+ 发布说明撰写给用户过目。
...
- [ ] T-1455 宽度走查 warm-streak 场景失效排查（tests/width-walkthrough.cjs:1133）
...
- [ ] T-1456 《认知觉醒》「早冥读写跑」打卡模板包（用户需求 2026-09-25，**已登记未开发，等开工指令**）
