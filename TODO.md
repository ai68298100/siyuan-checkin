...
- [ ] T-1443 主动提醒通道：事项置顶 + 每日统一提醒（用户需求 2026-09-24，**截图确认现状后登记，等开工指令**）
...
- [ ] T-1444 UI 缺陷：提醒中心操作按钮文字竖排挤压（用户截图 2026-09-24）
