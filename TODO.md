...
计划与交付标准见 [间隔打卡、文档绑定、每日日记、闪卡联动与同类产品调研](docs/roadmap-checkin-research-2026-09.md)。本轮只登记计划与初步资料，以下研究任务均保持开放；不预定算法、版本或上线日期，不直接启动功能开发。执行顺序：T-1377 建立对照资料 → T-1374～T-1376/T-1379 专题研究 → T-1378 归纳决策。延续用户选择偏好：有充分依据时自动采用推荐并记录理由，不要求用户逐项选择。
