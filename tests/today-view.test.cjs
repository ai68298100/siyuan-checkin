...
const todaySource = fs.readFileSync(path.join(sourceRoot, "render", "fragments.ts"), "utf8");
...
for (const filename of ["date-keys.ts", "model.ts", "record-step.ts", "analytics.ts", "export.ts", "quota.ts", "rules.ts", "types.ts"]) {
