...
["src/date-keys.ts", "src/i18n.ts", "src/lunar.ts", "src/occasions.ts", "src/record-step.ts", "src/features/reminder-preferences.ts", "src/features/first-success.ts", "src/features/view-scope.ts", "src/view-preferences.ts", "src/features/note-anchor.ts", "src/features/summary-resident.ts", "src/features/health-inbox.ts", "src/features/weread-adapter.ts", "src/catalog.ts", "src/features/templates.ts", "src/features/review-comparison.ts", "src/features/report.ts"].forEach(transpile);
