...
["src/date-keys.ts", "src/i18n.ts", "src/record-step.ts", "src/view-preferences.ts", "src/features/note-anchor.ts", "src/features/summary-resident.ts", "src/features/health-inbox.ts", "src/catalog.ts", "src/features/templates.ts", "src/features/review-comparison.ts", "src/features/report.ts"].forEach(transpile);
