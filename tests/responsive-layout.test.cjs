...
assert.match(components, /@container\s+lc5\s*\(min-width:\s*1000px\)[\s\S]*grid-template-columns:\s*var\(--lc-checkin-rail-width\)\s+minmax\(0,\s*1fr\)/,
    "desktop form must split into rail and content columns");
