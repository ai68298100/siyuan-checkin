...
for (const filename of ["date-keys.ts", "types.ts", "i18n.ts", "lunar.ts", "record-step.ts", "quota.ts", "rules.ts", "model.ts", "occasions.ts", "reminders.ts", "features/habit-score.ts", "features/insights.ts", "features/coaching.ts"]) {
