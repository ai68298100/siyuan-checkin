...
["src/types.ts", "src/i18n.ts", "src/record-step.ts", "src/quota.ts", "src/rules.ts", "src/ui/labels.ts", "src/shared.ts", "src/date-keys.ts", "src/model.ts", "src/features/record-notes.ts", "src/features/schedule-validate.ts", "src/features/project-draft.ts", "src/agent-suggestions.ts"].forEach(transpile);
