...
assert.match(source, /suggestionValuesEqual\(field, item\[field\], after\)/);
...
assert.match(source, /suggestionValuesEqual\(change\.field, next\[change\.field\], change\.before\)/);
...
assert.match(integration, /cloneIntegrationEvent/);
