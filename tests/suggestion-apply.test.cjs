...
fs.writeFileSync(path.join(root, "features", "schedule-validate.js"), ts.transpileModule(fs.readFileSync(path.join(__dirname, "..", "src", "features", "schedule-validate.ts"), "utf8"), {compilerOptions: {target: ts.ScriptTarget.ES2020, module: ts.ModuleKind.CommonJS}}).outputText, "utf8");
fs.writeFileSync(path.join(root, "features", "project-draft.js"), ts.transpileModule(fs.readFileSync(path.join(__dirname, "..", "src", "features", "project-draft.ts"), "utf8"), {compilerOptions: {target: ts.ScriptTarget.ES2020, module: ts.ModuleKind.CommonJS}}).outputText, "utf8");
