...
for (const key of ["report.contextTitle", "report.contextInsufficient", "report.contextToken.resistance", "report.contextToken.time", "report.contextToken.environment", "report.contextToken.health", "report.contextToken.mood", "report.contextToken.other"]) {
