...
assert.match(saveFormSource, /scheduleType === "interval"[\s\S]*intervalDays: intervalDaysValue, anchorDate: anchorDateValue/);
assert.match(saveFormSource, /scheduleType === "quota"[\s\S]*quota: \{period: requestedQuotaPeriod, amount: Math\.round\(quotaAmountValue \* 100\) \/ 100, countMode: requestedQuotaMode/);
