...
assert.match(indexSource, /buildWeeklyReportMarkdown\(summary, title, this\.reportSections, comparison, \{\.\.\.sourceOptions, viewScope, contextAggregation, stalledItems, missedByWeekday, missedByTimeSlot, targetLoad\}\)/, "diary report must reuse the exact review export path (incl. T-1425 scope + T-1433 context + T-1436 miss-time + stalled + T-1450 target-load)");
