...
["src/i18n.ts", "src/features/note-anchor.ts", "src/features/summary-resident.ts", "src/features/health-inbox.ts", "src/features/reminder-preferences.ts", "src/features/first-success.ts", "src/view-preferences.ts", "src/features/diary-search.ts"].forEach(transpile);
...
assert.match(indexSource, /buildWeeklyReportMarkdown\(summary, title, this\.reportSections, comparison, \{\.\.\.sourceOptions, viewScope\}\)/, "diary report must reuse the exact review export path (incl. T-1425 scope declaration)");
