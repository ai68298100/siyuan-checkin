...
for (const filename of ["date-keys.ts", "i18n.ts", "view-preferences.ts", "features/reminder-preferences.ts", "features/first-success.ts", "features/note-anchor.ts", "features/summary-resident.ts", "features/health-inbox.ts", "features/review-comparison.ts", "features/report.ts"]) {
