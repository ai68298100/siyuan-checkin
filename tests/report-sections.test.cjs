...
for (const filename of ["i18n.ts", "view-preferences.ts", "features/note-anchor.ts", "features/summary-resident.ts", "features/health-inbox.ts", "features/review-comparison.ts", "features/report.ts"]) {
