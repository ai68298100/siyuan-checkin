...
["src/i18n.ts", "src/features/note-anchor.ts", "src/features/summary-resident.ts", "src/view-preferences.ts", "src/render/settings.ts", "src/index.ts"].forEach(transpile);
