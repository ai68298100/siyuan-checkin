...
["src/i18n.ts", "src/features/note-anchor.ts", "src/features/summary-resident.ts", "src/features/health-inbox.ts", "src/features/reminder-preferences.ts", "src/view-preferences.ts", "src/render/settings.ts", "src/index.ts"].forEach(transpile);
