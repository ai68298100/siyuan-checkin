...
["src/i18n.ts", "src/record-step.ts", "src/date-keys.ts", "src/features/view-scope.ts", "src/features/reminder-preferences.ts", "src/features/first-success.ts", "src/view-preferences.ts", "src/features/note-anchor.ts", "src/features/summary-resident.ts", "src/features/health-inbox.ts", "src/catalog.ts", "src/features/templates.ts"].forEach(transpile);
