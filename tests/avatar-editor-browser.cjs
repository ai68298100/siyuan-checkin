...
(async () => {
    ...
    try {
        ...
        await page.addScriptTag({content: `window.__modules = {}; (() => {const exports = {}; ${compile("src/i18n.ts")} window.__modules.i18n = exports;})(); (() => {const exports = {}; const require = name => name === '../i18n' ? window.__modules.i18n : {}; ${compile("src/render/avatar-editor.ts")} window.__editor = exports;})(); (() => {const exports = {}; const require = () => ({validateAnchorBlockId: () => undefined}); ${compile("src/features/summary-resident.ts")} window.__modules.summaryResident = exports;})(); (() => {const exports = {}; const require = () => ({validateAnchorBlockId: () => undefined}); ${compile("src/features/health-inbox.ts")} window.__modules.healthInbox = exports;})(); (() => {const exports = {}; ${compile("src/features/weread-adapter.ts")} window.__modules.wereadAdapter = exports;})(); (() => {const exports = {}; ${compile("src/features/reminder-preferences.ts")} window.__modules.reminderPreferences = exports;})(); (() => {const exports = {}; ${compile("src/features/first-success.ts")} window.__modules.firstSuccess = exports;})(); (() => {const exports = {}; const require = name => name === './features/summary-resident' ? window.__modules.summaryResident : name === './features/health-inbox' ? window.__modules.healthInbox : name === './features/weread-adapter' ? window.__modules.wereadAdapter : name === './features/reminder-preferences' ? window.__modules.reminderPreferences : name === './features/first-success' ? window.__modules.firstSuccess : {validateAnchorBlockId: () => undefined}; ${compile("src/view-preferences.ts")} window.__preferences = exports;})();`});
        await page.evaluate(() => {
            window.__saved = [];
