...
assert.match(source, /data-restore-id[\s\S]*aria-label="恢复/, "restore actions must identify their item");
assert.match(source, /已恢复「\$\{expectedItem\.name\}」/, "successful restore must give named feedback");
