...
[最新 Release](https://github.com/ai68298100/siyuan-checkin/releases/latest) · [18.6.0 发布说明](docs/releases/release-notes-18.6.0.md) · [问题反馈](https://github.com/ai68298100/siyuan-checkin/issues) · [开发文档](docs/)
...
当前仓库的本地提交已增加笔记联动总览，并修复手机端已完成区域折叠与回顾页边界下拉。它们尚未进入 GitHub 最新 Release；通过 Release 安装的 18.6.0 暂不包含这些改动。
...
日记报告、摘要驻留、问卷日记、笔记锚点、叶归 LifeLog、思阅、思播、健康和微信读书均为可选联动。本地开发版在设置 → 外部联动中增加“笔记联动总览”，集中列出目标类型、目标 ID、启用状态和最近一次健康检查，并提供打开目标或跳到配置的入口。
