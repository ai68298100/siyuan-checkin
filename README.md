...
当前开发线：4.0 响应式工作台 UI 已完成代码与自动化验证；真实思源桌面端和移动端视觉验收仍待进行。
...
4.0 UI 工作台的迁移状态见 [`docs/superpowers/plans/2026-09-10-today-workbench-4-design.md`](docs/superpowers/plans/2026-09-10-today-workbench-4-design.md)，偏好字段与兼容策略见 [`docs/v2.0-migration-notes.md`](docs/v2.0-migration-notes.md)，生态 API 约定见 [`docs/ecosystem-integration.md`](docs/ecosystem-integration.md)。
