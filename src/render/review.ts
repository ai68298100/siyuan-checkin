...
export function renderReviewView(ctx: ReviewViewContext): string {
    ...
    return `<div class="lc-checkin lc-checkin--review" data-appearance="${ctx.appearance}">
            ...
            <nav class="lc-checkin__review-subnav" aria-label="回顾栏目"><button type="button" data-review-jump="0">提醒</button><button type="button" data-review-jump="1">趋势</button><button type="button" data-review-jump="2">项目</button><button type="button" data-review-jump="3">记录</button><button type="button" data-review-jump="4">成就</button></nav>
