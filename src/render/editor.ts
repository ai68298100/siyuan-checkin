                    ...
                    <details class="lc-checkin__advanced" data-advanced ${item ? "open" : ""}>
                        ...
                        <div class="lc-checkin__advanced-content">
                            ...
                            <div class="lc-checkin__organization-fields">
                                ...
                                <label class="lc-checkin__field"><span>${t("editor.autoArchiveLabel")}</span><input name="autoArchiveDays" type="number" inputmode="numeric" min="1" max="1000000" step="1" value="${item?.autoArchive?.afterDays ?? ""}" placeholder="${t("editor.autoArchiveOff")}" aria-label="${t("editor.autoArchiveLabel")}" /></label>
                                <label class="lc-checkin__field lc-checkin__field-check"><input name="directionAtMost" type="checkbox" ${item?.direction === "atMost" ? "checked" : ""} /><span>${t("editor.directionAtMost")}</span><small>${t("editor.directionAtMostHint")}</small></label>
