    ...
    const groups: Array<{id: string; label: string; body: string}> = [
        ...
        },
        {
            ...
            body: `
                    ...
                    <section class="lc-checkin__source-panel" data-source-panel="diary">
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.diaryIntegration")}</strong><span class="lc-checkin__source-badge${diary.enabled ? " is-on" : ""}">${diary.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></div>
                    ...
                    <section class="lc-checkin__source-panel" data-source-panel="summary">
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.summaryIntegration")}</strong><span class="lc-checkin__source-badge${summaryResident.enabled ? " is-on" : ""}">${summaryResident.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></div>
                    ...
                    <section class="lc-checkin__source-panel" data-source-panel="sireader">
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.sireaderIntegration")}</strong><span class="lc-checkin__source-panel-meta">${(ctx.sourceTodayCounts?.sireader ?? 0) > 0 ? `<span class="lc-checkin__source-today">${t("set.sourceToday", {n: ctx.sourceTodayCounts!.sireader})}</span>` : ""}<span class="lc-checkin__source-badge${sireader.enabled ? " is-on" : ""}">${sireader.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></span></div>
                    ...
                    <section class="lc-checkin__source-panel" data-source-panel="health">
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.healthIntegration")}</strong><span class="lc-checkin__source-badge${healthInbox.enabled ? " is-on" : ""}">${healthInbox.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></div>
                    ...
                    <section class="lc-checkin__source-panel" data-source-panel="siplayer">
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.siplayerIntegration")}</strong><span class="lc-checkin__source-panel-meta">${(ctx.sourceTodayCounts?.siplayer ?? 0) > 0 ? `<span class="lc-checkin__source-today">${t("set.sourceToday", {n: ctx.sourceTodayCounts!.siplayer})}</span>` : ""}<span class="lc-checkin__source-badge${siplayer.enabled ? " is-on" : ""}">${siplayer.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></span></div>
                    ...
                    <section class="lc-checkin__source-panel" data-source-panel="weread">
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.wereadIntegration")}</strong><span class="lc-checkin__source-panel-meta">${(ctx.sourceTodayCounts?.weread ?? 0) > 0 ? `<span class="lc-checkin__source-today">${t("set.sourceToday", {n: ctx.sourceTodayCounts!.weread})}</span>` : ""}<span class="lc-checkin__source-badge${weread.enabled ? " is-on" : ""}">${weread.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></span></div>
