    ...
    const groups: Array<{id: string; label: string; body: string}> = [
        ...
        },
        {
            ...
            body: `
                    ...
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.sireaderIntegration")}</strong><span class="lc-checkin__source-badge${sireader.enabled ? " is-on" : ""}">${sireader.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></div>
                    ...
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.siplayerIntegration")}</strong><span class="lc-checkin__source-badge${siplayer.enabled ? " is-on" : ""}">${siplayer.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></div>
                    ...
                    <div class="lc-checkin__source-panel-head"><strong>${t("set.wereadIntegration")}</strong><span class="lc-checkin__source-badge${weread.enabled ? " is-on" : ""}">${weread.enabled ? t("set.sourceBadgeOn") : t("set.sourceBadgeOff")}</span></div>
