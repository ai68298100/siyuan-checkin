    ...
    const groups: Array<{id: string; label: string; body: string}> = [
        ...
        },
        {
            ...
            body: `
                    ...
                    <div class="lc-checkin__settings-row"><span class="lc-checkin__settings-label"><span>${t("set.exportObsidian")}</span><small>${t("set.exportObsidianHint")}</small></span><button class="lc-checkin__text-button" type="button" data-action="export-obsidian">${t("set.exportLoopBtn")}</button></div>
