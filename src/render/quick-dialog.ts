...
export const AUTO_DIALOG_MAX_WIDTH = 1780;
/** Auto mode intentionally uses 90% of the viewport so content is not cramped. */
export const AUTO_DIALOG_WIDTH_RATIO = 0.9;
export const AUTO_DIALOG_HEIGHT_RATIO = 0.94;
